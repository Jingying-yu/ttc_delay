...
source of data (brief) structure of data & important attributes
...
purpose of extra dataset how it is related to subway_delay
...
why are these attributes kept for analysis (measurement) mention "code" column
