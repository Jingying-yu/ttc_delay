...
This paper specifically focuses on TTC bus, streetcar, and subway delay data from 2023, extracting and comparing them to identify which service type experienced the least amount of delay during weekday rush hours. Throughout the paper, *rush-hour* will refers to the periods from 7:00 AM to 9:00 AM (morning rush) and 4:00 PM to 7:00 PM (evening rush). Our findings indicate that, in 2023, the TTC subway system consistently demonstrated the shortest average delays.
...
-   all TTC services are the same price (one-fare)
